  ...
  implements BinaryEncoder, BinaryDecoder
{
    ...
    throws DecoderException
  {
    ...
    //   14: astore 4
    //   16: aload 4
    //   18: invokestatic 115	org/apache/commons/codec/binary/Hex:decodeHex	([C)[B
    //   21: areturn
    //   22: aload_1
    //   23: checkcast 116	[C
    //   26: checkcast 116	[C
    ...
    //   33: goto -17 -> 16
    //   36: astore_2
    //   37: new 54	org/apache/commons/codec/DecoderException
    //   40: dup
    //   41: aload_2
    //   42: invokevirtual 119	java/lang/ClassCastException:getMessage	()Ljava/lang/String;
    //   45: aload_2
    //   46: invokespecial 122	org/apache/commons/codec/DecoderException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   49: athrow
    ...
    throws org.apache.commons.codec.EncoderException
  {
    ...
    //   8: checkcast 74	java/lang/String
    //   11: aload_0
    //   12: invokevirtual 128	org/apache/commons/codec/binary/Hex:getCharsetName	()Ljava/lang/String;
    //   15: invokevirtual 139	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   18: astore 5
    //   20: aload 5
    //   22: invokestatic 76	org/apache/commons/codec/binary/Hex:encodeHex	([B)[C
    //   25: areturn
    //   26: aload_1
    //   27: checkcast 141	[B
    //   30: checkcast 141	[B
    ...
    //   39: goto -19 -> 20
    //   42: astore_3
    //   43: new 135	org/apache/commons/codec/EncoderException
    //   46: dup
    //   47: aload_3
    //   48: invokevirtual 119	java/lang/ClassCastException:getMessage	()Ljava/lang/String;
    //   51: aload_3
    //   52: invokespecial 142	org/apache/commons/codec/EncoderException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   55: athrow
    //   56: astore_2
    //   57: new 135	org/apache/commons/codec/EncoderException
    //   60: dup
    //   61: aload_2
    //   62: invokevirtual 132	java/io/UnsupportedEncodingException:getMessage	()Ljava/lang/String;
    //   65: aload_2
    //   66: invokespecial 142	org/apache/commons/codec/EncoderException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   69: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	70	0	this	Hex
