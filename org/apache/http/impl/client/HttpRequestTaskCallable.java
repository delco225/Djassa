    ...
    if (!this.cancelled.get()) {
      try
      {
        ...
        try
        {
          ...
          Object localObject2 = this.httpclient.execute(this.request, this.responseHandler, this.context);
          this.ended = System.currentTimeMillis();
          this.metrics.getSuccessfulConnections().increment(this.started);
          if (this.callback != null) {
            this.callback.completed(localObject2);
          }
          return localObject2;
        }
 ...
 * Qualified Name:     org.apache.http.impl.client.HttpRequestTaskCallable
